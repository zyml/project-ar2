...
var DEFAULT_SETTINGS = {
    ...
    // -- EDIT: Strings to be retrieved from WordPress for translation.
    hintText: ar2Admin_l10n.hintText,
    noResultsText: ar2Admin_l10n.noResultsText,
    searchingText: ar2Admin_l10n.searchingText,
    // -- END EDIT
    
    deleteText: "&times;",
    animateDropdown: true,
    theme: null,
    zindex: 600000, // <- Who in the right mind places .wp-full-overlay's z-index to 50000!?
    resultsLimit: null,
...
var methods = {
    ...
    setLimit: function(limit) {
    	this.data("tokenInputObject").setLimit(limit);
    	return this;
    }
}
    ...
    function run_search(query) {
        ...
        if(cached_results) {
            ...
            if(settings.url) {
                ...
                //-- EDIT: Add more params for WP AJAX
                ajax_params.data['action'] = settings.queryAction;
				ajax_params.data['limit'] = settings.limit;
                //-- END EDIT
